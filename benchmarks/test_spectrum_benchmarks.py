...
class TestSpectrumPerformance:
    ...
    def test_spectrum_creation_large_regular(self, benchmark, large_sample_data):
...
class TestSpectrumComparison:
    ...
    @pytest.mark.parametrize("size", [100, 1000, 5000, 10000])
    def test_jit_creation_performance_comparison(self, benchmark, comparison_data, size):
